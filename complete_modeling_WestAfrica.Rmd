...
wasting_plot = ggplot(data = data_wasted) + aes(x = Year, y = Wasted, col = admn0Nm) + geom_smooth(size = 1, alpha = 0.2) + ylab('Wasting prevalence') + 
  labs(fill = 'Country name') + theme_classic()

stunting_plot = ggplot(data = data_wasted) + aes(x = Year, y = Stunted, col = admn0Nm) + geom_smooth(size = 1, alpha = 0.2) + ylab('Stunting prevalence') + 
  labs(fill = 'Country name') + theme_classic()

grid_arrange_shared_legend(wasting_plot,stunting_plot, ncol=2, top = textGrob("Stunting and wasting prevalences over time",gp=gpar(fontsize=20)))
...
ggplot(data = world) +
    ...
    xlab('Longitude') + ylab('Latitude') + 
    ggtitle('Mean acute malnutrition prevalence in West Africa', subtitle = 'From 1998 to 2018, by region') + 
...
ggplot(data = world) +
    ...
    coord_sf(xlim =c(30, -20), ylim = c(0, 28), expand = FALSE) + 
    xlab('Longitude') + ylab('Latitude') + 
    ggtitle('Mean chronic malnutrition prevalence in West Africa', subtitle = 'From 1998 to 2018, by region') + 
